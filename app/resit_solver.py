...
# ✨ 1. إعداد المترجم المستقل
_current_translator = lambda message: message

def set_resit_algorithm_language(lang_code):
    global _current_translator
    try:
        # نحن الآن داخل: /app/resit_solver.py
        current_dir = os.path.dirname(os.path.abspath(__file__))
        
        # نصعد مستويين للأعلى في البرامج الأخرى، لكن هنا نصعد مستوى واحداً فقط:
        # من app إلى المجلد الرئيسي مباشرة
...
# ==============================================================================
def run_distribution(db, duration=5, destruction_rate=25, progress_callback=None, is_teacher_focused=False):
    ...
    final_violations = []
    unassigned_list = best_unassigned
